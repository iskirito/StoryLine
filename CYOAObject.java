           ...
           String name = scanner.nextLine();
            ...
            String choice = scanner.next();
              ...
              if (choice.equals("1")) {
            	...
            	System.out.println("You get the attention of your friends before telling them what you saw. Of course, none of them believe you. You should have used the code word that you and your friends used when you were little to warn of bullies.");
                System.out.println("It was your code for emergencies. As you are about to say the keyword, you quickly see a figure move on the walls, heading straight for your friend Mchensy.");
                System.out.println("It quickly rips his body in half, splattering blood over you and your friend Wuggle. You are about to scream, but you are quickly stopped by the blood-curdling scream of Wuggle next to you. His body is gouged and thrown at you, causing him to lay limp on top of you.");
                ...
                System.out.println(" It rolls to your feet, and you look down, seeing your friend's head. Your friend, who was alive not even five minutes ago, is now decapitated. His last look was horror and fear.");
