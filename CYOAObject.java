        ...
        while (playAgain) {
         ...
         System.out.println("5. Yell ----");
            ...
            if (choice.equals("1")) {
            	...
            	System.out.println("You mention the upstairs pointing up, your friends say it's not worth setting up there since the scenes are already so good at the bottom. You were gonna say you would feel safer up there but then there was a loud bang from the bottom of your feet. You instantly freeze for a second before moving away as quickly from the spot you were standing, but it follows you. Your friends hear the sound as well, and immediately realizing something is wrong you all quickly start packing your things, thinking maybe it's some sick prank or a weird earthquake. The sound continues to follow you until the floor starts cracking from beneath you. You all quickly bolt out the door only to see one of your friends, Staffard, fall into a hole set right in front of the porch. He fell at least 11 feet and didn't look as if he was conscious. As you use your gadget to go down the hole with your friends holding it from the top, you hear a loud bang from where they're at. You look up. A splotch of blood goes into your left eye as you see both your friends hanging lifelessly from a huge claw. The monster's other hand is holding the rope. It smiles. Your journey is about to end. You let go, letting yourself fall down the hole next to your friend. The last thing you see is the monster jump down, crushing your head.");
            } else if (choice.equals("5")) {
            	System.out.println("You yell the code word your friends have used since they were little, and immediately everyone turns their head toward you. They seem surprised for a second before immediately coming toward you. You panic because you don't know if what you saw was your imagination or if it could potentially put them in danger. However, you don't want to take any risks. You quickly rush everyone upstairs. As you guys are halfway up the long staircase, you hear something rushing from behind. You pull yourself up faster, turn around, and flash your camera light at the thing behind you. It shrieks at the light, stopping in its tracks for a second. It stands at 8 feet tall with huge horns on its cheeks, extending to its mouth, and has massive claws and terrifying arms—an ugly abomination. You continue up the stairs until you hear a scream next to you. Mchensy's body falls, and you see a leg falling through the air. You quickly turn around and notice the leg in the claws of the monster. You grab one of the camera stands you have and throw it like a spear, piercing the monster's eye—a lucky shot. It screams in rage and falls down the stairs. You and Staffard quickly help Mchensy arm up the stairs. As soon as you guys make it up there, you start discussing a plan with your crew to escape. However, suddenly couches and chairs are thrown through the floor with tremendous strength around you. The destruction causes each side of the floor to collapse, revealing the first floor below on both sides, about 10 feet apart. You can see the monster down there, looking up in rage with its one remaining eye. It can't reach you from there, but anyone hanging could be in danger. Your worst fears come to life as you see that your friends have been caught up. It's now up to you—Staffard hangs off the ledge to the left, while Wuggle hangs to the right, and Mchensy is safe in the middle but unable to help due to their severed leg. The creature is attempting to reach either of them, and you only have a limited amount of time. What do you do?");
                ...
                if (choice2.equals("1")) {
                    System.out.println("You pull Staffard up and immediately tell him to grab Wuggle, you try to carry mchensy but realize you want to do it alone, especially with that thing downstairs. In an act of stupid courage, you tell both your other friends to help Mchensy, as you jump down right into the monster's face, straight on with your feet. It screeches in surprise before realizing its overwhelming strength grabbing you before biting your arms off, you scream in pain as your friends escape. Hero's end.");
                } else if (choice2.equals("2")) {
                    System.out.println("You go towards wuggle, but fall and knocks his arm, causing him to fall to his death to the monster, mchensy screams in fright and goes delerious, having a heart attack, killing him on the spot. You immediatly help Staffard and escape, but not before forgetting wuggles still had the keys. “Clumsy” end.");
                } else if (choice2.equals("3")) {
                    System.out.println("You don't bother whether either of your other friends, thinking of them being lost caused, you host Mchensy and leave the other two as bait as you two escape to the woods. A couple of days later you were found my a search team in the mountains, too bad by then you both were eaten by wolfs, and are nothing left but decomposed bodies. Cowards Savior end.");
                } else if (choice2.equals("4")) {
                    System.out.println("Scared for your life you run, leaving your friends behind, as they cry in anguish over your betrayal you run down the mountain, and found a couple days later. You survived, but at what cost? No one believed you and your story, and evcentually convicted of killing your three friends. You sit alone in prison in silence, slowly rotting away for the rest of your life. Unforgiven end.");
                } else if (choice2.equals("rope")) {
                    System.out.println("You use the rope, throwing each end at both sides while tying it to yourself, pulling them both up at the same time, saving you so much time you immediately tell the two to give you their cameras. They comply and you immediately look down to where the monster is, you take out the lithium battery and immediately pull up your lucky lighter. You kiss it goodbye before quickly lighting it with the lithium battery throwing it down onto the monster and setting it ablaze. It starts squirming on the ground, with its distraction your friends and you bolt it out of the house and into the van. Most of the house is set on fire now, and as the car is being turned on you see the silhouette of the monster through the flames, staring at you. It seemed as if it was a sense of longing from its eyes, but you pay it no mind, as your friend stepped on the gas, leaving the burning house into the distance. True end.");
                } else {
